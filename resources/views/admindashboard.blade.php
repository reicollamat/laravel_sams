...
<div class="p-4 sm:ml-64">
   <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
      ...
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vero ad vel fugiat a amet, id, dolores saepe assumenda
         ...
         amet consectetur adipisicing elit. Eligendi fuga ad qui quia quam eaque nulla sed cum labore numquam, voluptas
         natus? Commodi adipisci dolorum ducimus quas voluptate, earum nam!</p>
      ...
      {{-- <ol class="relative border-l border-gray-200 dark:border-gray-700">
         <li class="mb-10 ml-4">
            ...
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">adminApplication UI code in Tailwind CSS
            </h3>
